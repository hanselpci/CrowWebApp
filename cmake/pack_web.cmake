...
set(PACK_WEB_TEST_FILE ${CMAKE_SOURCE_DIR}/build/lib/pack_web_test.cpp)
set(PACK_WEB_TEST_SRC_FILE ${CMAKE_SOURCE_DIR}/3rd/binfs/test/pack_web_test.cpp)
...
add_custom_command(
  OUTPUT ${PACK_WEB_TEST_FILE}  # output file
  DEPENDS ${WEB_RESOURCES_HPP} ${PACK_WEB_TEST_SRC_FILE}
  COMMAND ${CMAKE_COMMAND} -E copy ${PACK_WEB_TEST_SRC_FILE} ${PACK_WEB_TEST_FILE}
  COMMAND ${CMAKE_CXX_COMPILER}
            ${PACK_WEB_TEST_SRC_FILE}
            ${CMAKE_CXX_FLAGS} -I${CMAKE_SOURCE_DIR}/build/lib
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/build/lib
  BYPRODUCTS ${PACK_WEB_TEST_FILE}
...
add_custom_target(pack_web
  DEPENDS ${WEB_RESOURCES_HPP} ${PACK_WEB_TEST_FILE}
)
